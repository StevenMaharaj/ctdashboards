...
> **Prerequisites**: Basic command‑line familiarity and programming experience (any language).
...
### 3.3 Windows
Download the installer from <https://www.postgresql.org/download/windows/> and follow the wizard. Remember your superuser password (default user is **postgres**).
...
> **SERIAL vs IDENTITY**: From Postgres 10+, `GENERATED BY DEFAULT AS IDENTITY` is preferred:
```sql
